...
final class _SettingsTabs extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Keep both rounded ends and the shadow inside the window. Only the
    // tabs scroll; putting the surface inside the scroll view also scrolled
    // its rounded ends and margins out of sight on narrow windows.
    return Padding(
      padding: const EdgeInsets.all(_kTabsMargin),
      child: Center(widthFactor: 1, heightFactor: 1, child: bar),
    );
  }
}
